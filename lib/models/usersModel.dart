...
class UsersModel {
  ...
  factory UsersModel.fromMap(Map<String, dynamic> map) {
    return UsersModel(
      ...
      pnamelong: map['pnamelong'] == null ? '' : map['pnamelong'], 
      fname: map['fname'] == null ? '' : map['fname'], 
      lname: map['lname'] == null ? '' : map['lname'], 
      cid: map['cid'] == null ? '' : map['cid'], 
      fingle: map['fingle'] == null ? '' : map['fingle'], 
      tel: map['tel'] == null ? '' : map['tel'], 
      username: map['username'] == null ? '' : map['username'], 
      passapp: map['passapp'] == null ? '' : map['passapp'],  
      email: map['email'] == null ? '' : map['email'],
      emailverifiedat: map['emailverifiedat'] == null ? '' : map['emailverifiedat'],
      remembertoken: map['remembertoken'] == null ? '' : map['remembertoken'],
      ...
      line_token: map['line_token'] == null ? '' : map['line_token'],
      group_p4p: map['group_p4p'] == null ? '' : map['group_p4p'],
      dep_id: map['dep_id'] == null ? '' : map['dep_id'],
      dep_name: map['dep_name'] == null ? '' : map['dep_name'], 
      dep_subid: map['dep_subid'] == null ? '' : map['dep_subid'],
      dep_subname: map['dep_subname'] == null ? '' : map['dep_subname'],
      dep_subsubid: map['dep_subsubid'] == null ? '' : map['dep_subsubid'],
      dep_subsubname: map['dep_subsubname'] == null ? '' : map['dep_subsubname'],
      dep_subsubtrueid: map['dep_subsubtrueid'] == null ? '' : map['dep_subsubtrueid'],
      dep_subsubtruename: map['dep_subsubtruename'] == null ? '' : map['dep_subsubtruename'],
      users_type_id: map['users_type_id'] == null ? '' : map['users_type_id'],
      users_type_name: map['users_type_name'] == null ? '' : map['users_type_name'],
      users_group_id: map['users_group_id'] == null ? '' : map['users_group_id'],
      users_group_name: map['users_group_name'] == null ? '' : map['users_group_name'],
      position_id: map['position_id'] == null ? '' : map['position_id'],
      position_name: map['position_name'] == null ? '' : map['position_name'],
      status: map['status'] == null ? '' : map['status'],
      permiss_person: map['permiss_person'] == null ? '' : map['permiss_person'],
      permiss_book: map['permiss_book'] == null ? '' : map['permiss_book'],
      permiss_car: map['permiss_car'] == null ? '' : map['permiss_car'],
      permiss_meetting: map['permiss_meetting'] == null ? '' : map['permiss_meetting'],
      permiss_repair: map['permiss_repair'] == null ? '' : map['permiss_repair'],
      permiss_com: map['permiss_com'] == null ? '' : map['permiss_com'],
      permiss_medical: map['permiss_medical'] == null ? '' : map['permiss_medical'],
      permiss_hosing: map['permiss_hosing'] == null ? '' : map['permiss_hosing'],
      permiss_plan: map['permiss_plan'] == null ? '' : map['permiss_plan'],
      permiss_asset: map['permiss_asset'] == null ? '' : map['permiss_asset'],
      permiss_supplies: map['permiss_supplies'] == null ? '' : map['permiss_supplies'],
      permiss_store: map['permiss_store'] == null ? '' : map['permiss_store'],
      permiss_store_dug: map['permiss_store_dug'] == null ? '' : map['permiss_store_dug'],
      permiss_pay: map['permiss_pay'] == null ? '' : map['permiss_pay'],
      permiss_money: map['permiss_money'] == null ? '' : map['permiss_money'],
      permiss_claim: map['permiss_claim'] == null ? '' : map['permiss_claim'],
      permiss_ot: map['permiss_ot'] == null ? '' : map['permiss_ot'],
      permiss_medicine: map['permiss_medicine'] == null ? '' : map['permiss_medicine'],
      store_id: map['store_id'] == null ? '' : map['store_id'],
      member_id: map['member_id'] == null ? '' : map['member_id'],
      img: map['img'] == null ? '' : map['img'],
      img_name: map['img_name'] == null ? '' : map['img_name'],
      money: map['money'] == null ? '' : map['money'],
      remember_token: map['remember_token'] == null ? '' : map['remember_token'],
      color_ot: map['color_ot'] == null ? '' : map['color_ot'],
      created_at: map['created_at'] == null ? '' : map['created_at'],
      updated_at: map['updated_at'] == null ? '' : map['updated_at'],
      permiss_gleave: map['permiss_gleave'] == null ? '' : map['permiss_gleave'],
      permiss_p4p: map['permiss_p4p'] == null ? '' : map['permiss_p4p'],
      permiss_time: map['permiss_time'] == null ? '' : map['permiss_time'],
      permiss_env: map['permiss_env'] == null ? '' : map['permiss_env'],
      permiss_account: map['permiss_account'] == null ? '' : map['permiss_account'],
      permiss_dental: map['permiss_dental'] == null ? '' : map['permiss_dental'],
      small_id: map['small_id'] == null ? '' : map['small_id'],
      permiss_setting_account: map['permiss_setting_account'] == null ? '' : map['permiss_setting_account'],
      permiss_setting_upstm: map['permiss_setting_upstm'] == null ? '' : map['permiss_setting_upstm'],
      permiss_setting_env: map['permiss_setting_env'] == null ? '' : map['permiss_setting_env'],
      permiss_ucs: map['permiss_ucs'] == null ? '' : map['permiss_ucs'],
      permiss_sss: map['permiss_sss'] == null ? '' : map['permiss_sss'],
      permiss_ofc: map['permiss_ofc'] == null ? '' : map['permiss_ofc'],
      permiss_lgo: map['permiss_lgo'] == null ? '' : map['permiss_lgo'],
      permiss_prb: map['permiss_prb'] == null ? '' : map['permiss_prb'],
      permiss_ti: map['permiss_ti'] == null ? '' : map['permiss_ti'],
      permiss_setting_warehouse: map['permiss_setting_warehouse'] == null ? '' : map['permiss_setting_warehouse'],
      permiss_rep_money: map['permiss_rep_money'] == null ? '' : map['permiss_rep_money'], 
    );
  }
