...
class _AuthenPullState extends State<AuthenPull> {
  ...
  Future<void> fdh_countauthennull() async {
    final url_anull = '${MyConstant.fdh_countauthennull}';
    await Dio().get(url_anull).then((values) async {
  ...
  Future<void> fdh_sumincome_authen() async {
    ...
    await Dio().get(urlincome).then((values) async {
      var fdh_sumincomeauthen = values.toString();
      ...
      if (values.toString() == '{}') {
        ...
        setState(() {
          total_amont_authen = fdh_sumincomeauthen;
        });
      }
      print('## value for API  fdh_sumincomeauthen==>  $fdh_sumincomeauthen');
    });
  }
  ...
  Future<void> fdh_sumincome_noauthen() async {
    ...
    await Dio().get(urlincome).then((values) async {
      var fdh_sumincome_noauthen = values.toString();
      ...
      if (values.toString() == '{}') {
        ...
        setState(() {
          total_amont_noauthen = fdh_sumincome_noauthen;
        });
      }
      print(
          '## value for API  fdh_sumincome_noauthen==>  $fdh_sumincome_noauthen');
    });
  }
